  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        if(@$_GET['q']==10) {
          ...
          <thead><tr><th><b>S.N.</b></th><th><b>Topic</b></th><th><b>Total questions</b></th><th><b>Marks for right answer</b></th><th><b>Marks deducted for wrong answer</b></th><th><b>Total Marks</b></th><th><b>Time Limit</b></th><th><b>Test Status</b></th></tr></thead>
          ';
          $c=1;
          echo '<tbody>';
          while($row = mysqli_fetch_array($result)) {
            ...
            $rowcount=mysqli_num_rows($q12);
              ...
              echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$rights.'</td><td>'.$wrongs.'</td><td>'.$rights*$total.'</td><td>'.$time.'&nbsp;min</td>                
              <td>';
        ...
        if(@$_GET['q']==2 AND ($usertype==0||$usertype==1))
        {
          ...
          echo  '<div class="panel"><div class="table-responsive"><table id="example1" class="table table-bordered table-striped">
          <thead><tr><th><b>S.N.</b></th><th><b>Topic</b></th><th><b>Total questions</b></th><th><b>Marks for Right Answer</b></th><th><b>Marks for wrong Answer</b></th><th><b>Total Marks</b></th><th><b>Time limit</b></th><th><b>Test Status</b></th>';
          if($usertype==0)
            echo'<th><b>Delete Test</b></th><th><b>Delete Test</b></th>';
          else echo'<th><b>Delete Test</b></th>';
          echo '</tr></thead>';
          $c=1;
          echo '<tbody>';
          while($row = mysqli_fetch_array($result)) {
